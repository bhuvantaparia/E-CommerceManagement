...
public class UserController {
	...
	// Register a new buyer i/p= complete details
	...
	// Register a new seller i/p= complete details
	...
	// Login a new buyer i/p email and password
	...
	// Login a new seller i/p email and password
	...
	//Deactivate Buyer based on email -------i/p email
	...
	//Deactivate Seller based on seller email-------i/p email
	...
	// adding product to wishlist (Buyer)-------i/p buyerid, prodid
	...
	//Min i/p = buyerid,prodid,quantity
	...
	//removing product from wishlist (Buyer)-------i/p buyerid, prodid
	...
	//removing product from cart (Buyer)-------i/p buyerid, prodid
	...
	// inactivate a buyer---------temporary---------i/p buyer email
	...
	// activate a buyer--------temporary---------i/p buyer email
	...
	// inactivate a seller----------temporary---------i/p seller email
	...
	// activate a buyer--------temporary---------i/p seller email
	...
	//updatePrivilege-----------i/p = buyer email
